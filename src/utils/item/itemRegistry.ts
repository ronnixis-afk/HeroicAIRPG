...
export const LOOT_TABLES: Record<string, Partial<Item>[]> = {
    ...
    consumables: [
        { name: 'Minor Healing Potion', tags: ['consumable'], effect: { type: 'Heal', healDice: '1d8', targetType: 'Single' } },
        { name: 'Healing Potion', tags: ['consumable'], effect: { type: 'Heal', healDice: '2d8', targetType: 'Single' } },
        { name: 'Scroll of Healing', tags: ['consumable'], effect: { type: 'Heal', healDice: '2d8', targetType: 'Single' } },
