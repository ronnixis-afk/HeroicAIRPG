...
export const LOOT_TABLES: Record<string, Partial<Item>[]> = {
    weapons: [
        ...
        // Ranged
        { name: 'medium_weapon_p_1_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d4', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_p_2_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d8', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_p_3_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d10', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_s_1_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d4', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_s_2_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d8', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_s_3_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d10', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_b_1_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d4', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_b_2_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d8', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'medium_weapon_b_3_r', tags: ['weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d10', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
        ...
        // Ranged
        { name: 'heavy_weapon_p_1_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d12', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_p_2_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d6', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_p_3_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d8', type: 'Piercing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_s_1_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d12', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_s_2_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d6', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_s_3_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d10', type: 'Slashing' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_b_1_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d12', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_b_2_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '2d6', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
        { name: 'heavy_weapon_b_3_r', tags: ['heavy weapon', 'ranged'], bodySlotTag: 'Main Hand', weaponStats: { ability: 'dexterity', damages: [{ dice: '1d10', type: 'Bludgeoning' }], enhancementBonus: 0, critRange: 20 } },
    ],
    armors: [
    ...
    consumables: [
        ...
        { name: 'Elixir of Focus', tags: ['consumable'], buffs: [{ type: 'combat', bonus: 1, duration: 'Active' }] as any },
        { name: 'Scroll of Protection', tags: ['consumable'], buffs: [{ type: 'ac', bonus: 1, duration: 'Active' }] as any },
        { name: 'Scroll of Striking', tags: ['consumable'], buffs: [{ type: 'damage', bonus: 1, duration: 'Active' }] as any },
        { name: 'Vial of Resistance', tags: ['consumable'], buffs: [{ type: 'save', bonus: 1, duration: 'Active' }] as any },
    ],
    utilities: [
    ...
    throwables: [
        { name: 'Alchemist\'s Fire', tags: ['ammunition', 'throwable'], bodySlotTag: 'Main Hand', effect: { type: 'Damage', damageType: 'Fire', targetType: 'Single' } },
        { name: 'Acid Vial', tags: ['ammunition', 'throwable'], bodySlotTag: 'Main Hand', effect: { type: 'Damage', damageType: 'Acid', targetType: 'Single' } },
        { name: 'Holy Water', tags: ['ammunition', 'throwable'], bodySlotTag: 'Main Hand', effect: { type: 'Damage', damageType: 'Radiant', targetType: 'Single' } },
        { name: 'Explosive Charge', tags: ['ammunition', 'throwable'], bodySlotTag: 'Main Hand', effect: { type: 'Damage', damageType: 'Fire', targetType: 'Multiple', dc: 12, saveAbility: 'dexterity', saveEffect: 'half' } },
        ...
        { name: 'Incendiary Flask', tags: ['ammunition', 'throwable'], bodySlotTag: 'Main Hand', effect: { type: 'Damage', damageType: 'Fire', targetType: 'Multiple', dc: 12, saveAbility: 'dexterity', saveEffect: 'half' } },
    ],
    quest: [
