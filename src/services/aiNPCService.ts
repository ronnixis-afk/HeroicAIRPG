...
export const extractNPCsFromNarrative = async (
    ...
    4. **LIFE STATUS RULE**: Determine if the character is "Alive" or "Dead" based on the narrative. If the user stumbles upon a corpse or witnesses a death, set "status": "Dead".
...
export const refineNPCDetails = async (
    ...
    3. **LIFE STATUS**: Determine if they are currently "Alive" or "Dead" based on recent history.
