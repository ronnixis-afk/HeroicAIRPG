      ...
      <div className="flex items-center gap-3">
        <button onClick={onMenuClick} className="btn-icon p-1 text-brand-text-muted hover:text-brand-accent transition-colors relative">
          ...
          {badgeCount !== undefined && badgeCount > 0 && (
            <span className="absolute -top-1.5 -right-1.5 bg-brand-accent text-black text-[8px] font-bold h-[18px] min-w-[18px] px-1 rounded-full flex items-center justify-center border border-brand-bg z-10 shadow-sm animate-pulse">
...
const GameInterface: React.FC = () => {
  ...
  const currentPopulationLevel = useMemo(() => {
