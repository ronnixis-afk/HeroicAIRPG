    ...
    <div className="bg-brand-primary/20 p-4 rounded-2xl flex justify-between items-center border border-brand-surface shadow-inner group hover:bg-brand-primary/40 transition-all">
        <div className="flex flex-col gap-1 overflow-hidden pr-3">
            <div className="flex items-center gap-2">
                ...
                <p className="text-body-base font-bold text-brand-text truncate uppercase tracking-tight">{item.getDisplayName()}</p>
            </div>
            ...
            <div className="space-y-8 py-2 animate-fade-in">
                {lootState.isLoading ? (
                    <div className="flex flex-col items-center justify-center min-h-[300px] space-y-4">
                        ...
                        <p className="text-body-base text-brand-text-muted font-bold tracking-widest uppercase">Generating Loot...</p>
                    </div>
                ) : (
                    <div className="space-y-8 pb-4">
                        <div className="bg-brand-primary/10 p-5 rounded-3xl border border-brand-surface shadow-inner">
                            <h5 className="text-[10px] font-black text-brand-text-muted uppercase tracking-widest mb-4 px-1 leading-none">Defeated Foes</h5>
                        ...
                        <div className="space-y-3">
                            <label className="block text-[10px] font-black text-brand-text-muted uppercase tracking-widest mb-4 px-1 leading-none">Found Loot</label>
