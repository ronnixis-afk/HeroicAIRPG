...
const iconPaths: { [key: string]: React.ReactElement } = {
  ...
  skull: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" stroke="currentColor">
  ...
  heroicAction: (
    <svg viewBox="0 0 77.06 77.22" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M63.78,38.64L77.04.61c.12-.34-.21-.66-.55-.53l-27.9,10.44c-.35.13-.58.46-.58.83v11.54c0,2.03-1.64,3.67-3.67,3.67h-11.63c-2.03,0-3.67-1.64-3.67-3.67v-11.6c0-.37-.23-.7-.58-.83L.59.03C.26-.1-.07.22.05.56l13.26,38.07L.02,76.66c-.12.34.21.66.54.53l27.89-10.36c.35-.13.58-.46.58-.83v-16.78c0-2.03,1.64-3.67,3.67-3.67h11.63c2.03,0,3.67,1.64,3.67,3.67v16.71c0,.37.23.71.58.83l27.86,10.26c.33.12.66-.2.54-.53l-13.22-37.85Z"/>
    </svg>
  ),
  heroicActionOutline: (
    <svg viewBox="0 0 77.06 77.22" fill="none" stroke="currentColor" strokeWidth={4} xmlns="http://www.w3.org/2000/svg">
      <path d="M63.78,38.64L77.04.61c.12-.34-.21-.66-.55-.53l-27.9,10.44c-.35.13-.58.46-.58.83v11.54c0,2.03-1.64,3.67-3.67,3.67h-11.63c-2.03,0-3.67-1.64-3.67-3.67v-11.6c0-.37-.23-.7-.58-.83L.59.03C.26-.1-.07.22.05.56l13.26,38.07L.02,76.66c-.12.34.21.66.54.53l27.89-10.36c.35-.13.58-.46.58-.83v-16.78c0-2.03,1.64-3.67,3.67-3.67h11.63c2.03,0,3.67,1.64,3.67,3.67v16.71c0,.37.23.71.58.83l27.86,10.26c.33.12.66-.2.54-.53l-13.22-37.85Z"/>
    </svg>
  ),
  male: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="m21 3-6.15 6.15" />
